...
DATABASES = {
    "default": {
        ...
        "USER": "postgres",  #Ton nom d'utilisateur
        "PASSWORD": "Studietudiant1.",  # Mot de passe
        "HOST": "localhost",  # Adresse de l'hôte (l'IP de ton serveur PostgreSQL ici en local)
        "PORT": "5432",  # Port utiliser pour l'accé (par défaut pour PostgreSQL)
    }
}
...
MEDIA_ROOT = os.path.join(
    BASE_DIR, "main", "profils_picture"
)  # Ou 'media/profils_picture'
