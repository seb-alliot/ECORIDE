        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "commentaire",
                    models.TextField(
                        blank=True, null=True, verbose_name="Commentaire du passager"
                    ),
                ),
                (
                    "chauffeur",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=20,
                        verbose_name="Gérer le paiement",
                    ),
                ),
                (
                    "commentaire_moderer",
                    models.BooleanField(
                        default=False, verbose_name="cocher si commentaire valider"
                    ),
                ),
                ("decision_prise", models.BooleanField(default=False)),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Date de modération"
                    ),
                ),
                (
                    "modified_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="commentaire_moderer",
                        to="main.noteuser",
                    ),
                ),
            ],
            options={
                "verbose_name": "Modération des avis",
                "verbose_name_plural": "Modérations des avis",
            },
        ),
        migrations.CreateModel(
            name="Preference",
